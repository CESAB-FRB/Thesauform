								...
								<c:when test="${myTypeList.key=='current'}">
									<tr>
										...
										<td><select title="prefLabel${count}" class="notation"
											onchange="addVote(this.title, '${myTraitVote.uri}', 'prefLabel', '${fn:replace(prop.key,'\'','\\\'')}', this.options[this.selectedIndex].value);">
												<option
								...
								<c:when test="${myTypeList.key=='current'}">
									<tr>
										...
										<td><select title="def${count}" class="notation"
											onchange="addVote(this.title, '${myTraitVote.uri}', 'definition', '${fn:replace(prop.key,'\'','\\\'')}', this.options[this.selectedIndex].value);">
												<option
													<c:if test="${prop.value==0}">selected="selected"</c:if>
													value="0">no response</option>
												<option
								...
								<c:when test="${myTypeList.key=='current'}">
									<tr>
										...
										<td><select title="abbrev${count}" class="notation"
											onchange="addVote(this.title, '${myTraitVote.uri}', 'abbreviation', '${fn:replace(prop.key,'\'','\\\'')}', this.options[this.selectedIndex].value);">
												<option
													<c:if test="${prop.value==0}">selected="selected"</c:if>
													value="0">no response</option>
												<option
								...
								<c:when test="${myTypeList.key=='current'}">
									<tr>
										...
										<td><select title="syn${count}" class="notation"
											onchange="addVote(this.title, '${myTraitVote.uri}', 'altLabel', '${fn:replace(prop.key,'\'','\\\'')}', this.options[this.selectedIndex].value);">
												<option
													<c:if test="${prop.value==0}">selected="selected"</c:if>
													value="0">no response</option>
												<option
					...
					<c:forEach items="${myTraitVote.relatedList}" var="prop">
						<tr>
							...
							<td><select title="rel${count}" class="notation"
								onchange="addVote(this.title, '${myTraitVote.uri}', 'related', '${fn:replace(prop.key,'\'','\\\'')}', this.options[this.selectedIndex].value);">
									<option
										<c:if test="${prop.value==0}">selected="selected"</c:if>
										value="0">no response</option>
									<option
								...
								<c:when test="${myTypeList.key=='current'}">
									<tr>
										...
										<td><select title="unit${count}" class="notation"
											onchange="addVote(this.title, '${myTraitVote.uri}', 'prefUnit', '${fn:replace(prop.key,'\'','\\\'')}', this.options[this.selectedIndex].value);">
												<option
													<c:if test="${prop.value==0}">selected="selected"</c:if>
													value="0">no response</option>
												<option
								...
								<c:when test="${myTypeList.key=='current'}">
									<tr>
										...
										<td><select title="category${count}" class="notation"
											onchange="addVote(this.title, '${myTraitVote.uri}', 'broaderTransitive', '${fn:replace(prop.key,'\'','\\\'')}', this.options[this.selectedIndex].value);">
												<option
													<c:if test="${prop.value==0}">selected="selected"</c:if>
													value="0">no response</option>
												<option
