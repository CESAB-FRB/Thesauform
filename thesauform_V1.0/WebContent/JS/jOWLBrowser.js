...
function createConceptWidget(){
		...
		var autocomplete = $('#owlauto').owl_autocomplete({focus : true, chars : 2, filter : 'rdf:Description'});
		//var autocompleteA = $('#related').owl_autocompleteA({focus : true, chars : 2, champ : $('#related') , filter : 'rdf:Description'});
		//var autocompleteB = $('#syn').owl_autocompleteA({focus : true, chars : 2, champ : $('#syn') , filter : 'rdf:Description'});
		...
		//autocompleteA.addListener([tree, navbar, descriptionpanel]);
		//autocompleteB.addListener([tree, navbar, descriptionpanel]);
